                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">                                            
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    <input type="text" class="form-control" id="estu_codigo" value="<?php echo $stu->estu_codigo; ?>" name="estu_codigo" placeholder="Código" required="required">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="form-group"> 
                                                <div class="col-sm-offset-2 col-sm-8">                                           
                                                    <input type="text" class="form-control fecha" value="<?php echo $stu->estu_fingreso; ?>" name="fingreso" placeholder="Fecha de ingreso" required="required">
                                                    <div class="help-block with-errors"></div>
                                                </div>                                                
                                            </div>
                                            <div class="form-group">                                            
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    ...
                                                    <?php foreach ($prog as $pg): ?>
                                                        <option <?php if ($stu->estu_idprog == $pg->prog_id) { echo "selected='selected'"; } ?> value="<?php echo $pg->prog_id; ?>"><?php echo $pg->prog_nombre; ?></option>
                                                    <?php endforeach ?>
                                                    </select>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            ...
                                            <div class="form-group">                                            
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    ...
                                                    <?php foreach ($estaacad as $estac): ?>
                                                        <option <?php if ($stu->estu_idestaacad == $estac->estaacad_id) { echo "selected='selected'"; } ?> value="<?php echo $estac->estaacad_id; ?>"><?php echo $estac->estaacad_nombre; ?></option>
                                                    <?php endforeach ?>
                                                    </select>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            ...
                                            <div class="form-group">                                            
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    <input type="text" class="form-control" id="estu_tel" value="<?php echo $stu->estu_telefono; ?>" name="estu_tel" placeholder="N° de teléfono" required="required">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="form-group">                                            
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    <input type="text" class="form-control" id="estu_dire" value="<?php echo $stu->estu_direccion; ?>" name="estu_direccion" placeholder="Dirección de residencia" required="required">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>                                            
                                            <div class="form-group">                                            
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    <select class="form-control" id="estu_genero" name="estu_genero" required="required">                                                    
                                                        <option <?php if ($stu->estu_genero == 'M') { echo "selected='selected'"; } ?> value="M">MASCULINO</option>
                                                        <option <?php if ($stu->estu_genero == 'F') { echo "selected='selected'"; } ?> value="F">FEMENINO</option>
                                                    </select>
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                            <div class="form-group"> 
                                                <div class="col-sm-offset-2 col-sm-8">                                           
                                                    <input type="text" class="form-control fecha" value="<?php echo $stu->estu_fnacimiento; ?>" name="fnacimiento" placeholder="Fecha de nacimiento" required="required">
                                                    <div class="help-block with-errors"></div>
                                                </div>                                                
                                            </div>
                                            <div class="form-group">                                                     
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    <select class="form-control" name="estu_rh" id="" required="required">
                                                       <option value="A+" <?php if ($stu->estu_rh=="A+") { echo "selected='selected'"; } ?>>A+</option>
                                                        <option value="B+" <?php if ($stu->estu_rh=="B+") { echo "selected='selected'"; } ?>>B+</option>
                                                        <option value="AB+" <?php if ($stu->estu_rh=="AB+") { echo "selected='selected'"; } ?>>AB+</option>
                                                        <option value="O+" <?php if ($stu->estu_rh=="O+") { echo "selected='selected'"; } ?>>O+</option>
                                                        <option value="A-" <?php if ($stu->estu_rh=="A-") { echo "selected='selected'"; } ?>>A-</option>
                                                        <option value="B-" <?php if ($stu->estu_rh=="B-") { echo "selected='selected'"; } ?>>B-</option>
                                                        <option value="AB-" <?php if ($stu->estu_rh=="AB-") { echo "selected='selected'"; } ?>>AB-</option>
                                                        <option value="O-" <?php if ($stu->estu_rh=="O-") { echo "selected='selected'"; } ?>>O-</option>
                                            ...
                                            <div class="form-group">                                            
                                                <div class="col-sm-offset-2 col-sm-8">
                                                    <select class="form-control" id="estu_idestado" name="estu_idestado" required="required">
                                                        <option <?php if ($stu->estu_idestado == 1) { echo "selected='selected'"; } ?> value="1">Activo</option>
                                                        <option <?php if ($stu->estu_idestado == 2) { echo "selected='selected'"; } ?> value="2">Inactivo</option>
                                                    </select>
                                                    <div class="help-block with-errors"></div>
                                                    <input type="hidden" value="<?php echo $stu->estu_id; ?>" name="estu_id" id="estu_id">
                                                    <input type="hidden" value="<?php echo $stu->estu_idusua; ?>" name="usua_id" id="usua_id">
